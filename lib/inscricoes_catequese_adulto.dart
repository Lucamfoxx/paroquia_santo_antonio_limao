          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: Text('Adicionar Documento', style: TextStyle(color: Colors.white)),
              ...
              ElevatedButton(
                ...
                child: _enviandoEmail
                    ...
                    : Text('Enviar Inscrição', style: TextStyle(color: Colors.white)),
...
(Tire foto de todos os documentos)''',
  ...
  Future<void> _enviarInscricao() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      bool enviado = await _emailService.enviarInscricaoPorEmail(formData, documentos);
