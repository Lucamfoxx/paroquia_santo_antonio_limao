...
''',
            ...
            SizedBox(height: 20),
            _buildImageSlider(
                context), // Adiciona o slider de imagens abaixo das informações
          ],
        ),
      ),
    );
